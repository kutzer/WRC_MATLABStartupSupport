function [fNames,fTypes] = findAllFilesAndFolder(pName,pIgnore)
% FINDALLFILESANDFOLDER recursively finds all files and folders within a 
% specified path.
%
%   fNames = findAllFilesAndFolder(pName)
%
%   fNames = findAllFilesAndFolder(pName,pIgnore)
%
%   [fNames,fTypes] = findAllFilesAndFolder(___)
%
%   Input(s)
